...
avec une condition ternaire conditonne l'affichage d'un template "x", et si la condition n'est pas remplie, un template "y".

Je te laisse faire, c'est pas compliqué maintenant que tu viens de t'ingurgiter la partie précédente...
